...
{
    public static final double G = 6.673e-11;   // гравитационная постоянная
    
    public static final double SOLAR_MASS=1.98892e30;

    public static final int TMP_BODIES_FACTOR = 15; // сколько места зарезервировать для временных тел, созданных при построении дерева ЧД
    ...
    {
        final double EPS = 3E4;      // параметр смягчения (во избежание бесконечностей)
